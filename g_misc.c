...
FREDZ
  ...
  Glass an entity.. can be used for client's or AI
=============
*/
...
//	int		mass;
	...
	gi.sound (self, CHAN_BODY, gi.soundindex ("world/glasbrk.wav"), 1, ATTN_NORM, 0);//FREDZ
...
void SP_misc_teleporter (edict_t *ent)
{
	...
	ent->s.renderfx2 |= RF2_NOSHADOW; // MH: remove dodgy shadow

	if (ent->sounds != 1)//FREDZ sound can be anoying
