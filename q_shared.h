...
#define	SFX_SPRITE_SURF_BLOOD1		0 //FREDZ Uses sprites/blood1.tga
#define	SFX_SPRITE_SURF_BULLET1		1 //sprites/bullet1.tga
#define	SFX_SPRITE_SURF_RIPPLE		2 //sprites/ripple.tga (Quickly disapear)
#define SFX_SPRITE_SURF_BLOOD_POOL  5 //sprites/bld_pl.tga
...
#define CHAN_BULLET				6 // MH: added for bullet hits
// modifier flags
...
//#define STAT_WEAPONTIMER	 24 // MH: changed from 23 to 24 (STAT_SHOWTIMER removed)
// END
