...
void Use_Target_Speaker (edict_t *ent, edict_t *other, edict_t *activator)
{
	...
	// MH: don't start during intermission
...
void use_target_blaster (edict_t *self, edict_t *other, edict_t *activator)
{
	...
	fire_blaster (self, self->s.origin, self->movedir, self->dmg, self->speed, EF_BLASTER, MOD_TARGET_ROCKET);//FREDZ was MOD_TARGET_BLASTER
